...
import com.printer.web.controller.FileUploadController;
...
public class SaveFile {
	...
	public static boolean saveFile(final String savePath,
			final String fileFullName, final MultipartFile file)
			throws Exception {
	 ...
	 * @throws IOException
	 */
	public static java.io.File getFileByPath(String filePath)
			throws IOException {
	 ...
	 * @throws IOException
	 */
	public static void zipFiles(List<File> srcFileList, java.io.File zipFile)
			throws IOException {
